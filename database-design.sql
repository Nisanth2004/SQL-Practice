...
/*
Implementation: This Schema should support storing details of customers,instrcutors,courses,lessons,enrollments,payments,
reviews, and admins as detailed previously

*/


CREATE DATABASE QUANTUM_TUTORS_DB;

USE QUANTUM_TUTORS_DB;
-- --------------------------------------------------------------
# CREATE statement in DDL
...
CREATE TABLE order_dummy (
    ...
    customer_id INT,
    quantity INT,
    FOREIGN KEY (customer_id) REFERENCES customer_dummy(id));
